...
# with col2:
#     animate_number(total, "총합", "#E5F0D4")
# with col3:
...
# # # 버튼 없이 페이지 링크 추가
st.sidebar.page_link("pages/1_4years.py", label="4년근")
st.sidebar.page_link("pages/2_5years.py", label="5년근")
st.sidebar.page_link("pages/3_6years.py", label="6년근")
